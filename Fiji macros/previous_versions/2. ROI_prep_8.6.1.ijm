 ...
 *  While these are two considerably different tasks, they use the same structure and work with the same files.
 *  For this reason they are included in a single macro.
 *
 * Additional plugins required:
 *  LabelMap to ROI Manager (2D) - add SCF-MPI-CBG update site
 ***************************************************************************************************************/

macro_name = "ROI preparation";
version = "8.6.1";
