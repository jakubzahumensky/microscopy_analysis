...
Dialog.create("Choose operation and image type");
	Dialog.addRadioButtonGroup("Select process:", processes, 2, 1, "Convert Masks to ROIs");
	Dialog.addRadioButtonGroup("Select image type of your data:", image_types, 2, 1, "Transversal");
	Dialog.show();
...
Dialog.create("ROI check");
	...
	Dialog.addCheckbox("go back", false); // the C. albicans images I quantified were obtained from decolvolution of z-stacks from a wide-field microscope. Different setting are therefore needed in this case
    Dialog.show();
